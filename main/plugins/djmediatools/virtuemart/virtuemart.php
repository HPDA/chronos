<?php
/**
 * @version $Id: virtuemart.php 15 2013-07-15 13:34:25Z szymon $
...
class plgDJMediatoolsVirtuemart extends JPlugin
{
	...
	public function onAlbumPrepare(&$source, &$params)
	{
		...
		foreach($products as $product){
			...
			$slide->link = JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id);
