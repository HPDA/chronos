<?php
/**
 * @version $Id: view.html.php 24 2013-12-18 09:34:54Z szymon $
						...
						if (document.formvalidator.isValid(document.id('item-form'))) {
							...
							document.id('item-form').set('send',{
								...
								onSuccess: function(responseText){
									...
									if (window.parent) window.parent.".$function."(response.id,response.image,response.title);
								},
								onFailure: function(){
									loader.destroy();
								}
