			...
			if($par->get('allow_user_lat_lng','0')){?>
	            ...
	            <div class="djform_row">
	            	<div class="djmap_intro">
	            		...
	            		<span class="button" id="map_use_my_location"><?php echo JText::_('COM_DJCLASSIFIEDS_USE_MY_LOCATION')?></span>
	            		<span class="button" id="map_update_latlng"><?php echo JText::_('COM_DJCLASSIFIEDS_UPDATE_USING_ADDRESS')?></span>
	            		<div style="clear:both"></div>
