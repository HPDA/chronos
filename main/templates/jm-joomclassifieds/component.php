...
<head>
    ...
    <link rel="stylesheet" href="<?php echo JURI::base(); ?>templates/<?php echo $this->template ?>/css/extensions.css" type="text/css" />
    <!-- load bootstrap -->
    <?php if ($this->direction == 'rtl') { ?>
        <?php JHtmlBootstrap::loadCss($includeMaincss = true, $this->direction = 'rtl'); ?>
        <link href="<?php echo JURI::base(); ?>templates/<?php echo $this->template ?>/css/extensions_rtl.css" rel="stylesheet" type="text/css" />
    <?php } else { ?>
