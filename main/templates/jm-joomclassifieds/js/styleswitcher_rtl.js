...
window.addEvent("domready",function(){
 if(document.id('jm-styleswitcher')){	
	...
	if (style_1) style_1.dispose();
		...
		new Cookie.write('jm_joomclassifieds','1',{duration: 200,path: "/"});
	...
	if (style_2) style_2.dispose();
		...
		new Cookie.write('jm_joomclassifieds','2',{duration: 200,path: "/"});
	...
	if (style_3) style_3.dispose();
		...
		new Cookie.write('jm_joomclassifieds','3',{duration: 200,path: "/"});
...
function changeStyle(style){
	...
	new Cookie.write('jm_joomclassifieds',style,{duration: 200,path: "/"});
}